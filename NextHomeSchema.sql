...
Located in famous Coral Springs, this home will not last!',
    485000,
    2149,
    4,
    3,
    "146 Coral Keys Drive",
    "NE",
    'mikailmunir01@gmail.com',
    'realtor.ca',
    'remax.ca/ab/jennifer-miller-117639-ag',
    "../img/146 Coral Keys Drive NE.jpeg"
  );
INSERT INTO `nextHome`.`Listings` (
    `MLSCode`,
    `BasementType`,
...
VALUES (
    '	A1162585',
    'Finished, Full',
    'VERY NEAT AND CLEAN HOUSE WITH 4+2 BEDROOMS 4.5 BATHS. MAIN FLOOR LIVING ROOM AND FAMILY ROOM. 
...
VALUES (
    'A1131234',
    "Full, Unfinished",
    "Are you ready to be completely wowed from start to finish? 
...
Convenient main floor laundry and office space. Upstairs everyone will love hanging out in the sunny foyer with vaulted ceilings.
 ...
 Don't let this stunning home get away!",
    ...
    3,
    4,
    "232 California Place",
    "NE",
    'mikailmunir01@gmail.com',
    'cirrealty.ca/',
    'cirrealty.ca/aimee_manser',
    "../img/232 California Place.jpeg"
  );
INSERT INTO `nextHome`.`Listings` (
    MLSCode,
    BasementType,
...
VALUES (
    'A1165568',
    "Full, Walkout",
    "The One You Have Been Waiting For JUST LISTED 
...
Only FEW STEPS from MARTIN CROSSING SCHOOL, CLOSE to ALL Amenities
 ...
 Truly pleasure to VIEW ANYTIME, Do not hesitate to make this home yours, it will not be on the market for long !!!",
    ...
    3,
    3,
    "38 Martinridge Crescent",
    "NE",
    'mikailmunir01@gmail.com',
    'bamberrealty.c21.ca/',
    'c21.ca/directory/agents/suman-brar',
    "../img/38 Martinridge Crescent.jpeg"
  );
INSERT INTO `nextHome`.`Listings` (
    MLSCode,
    BasementType,
...
VALUES (
    'A1165352',
    "Full, Unfinished",
    "A 2015 built, open concept house in the very convenient neighborhood of Cityscape NE. 
...
the exterior, the house has a detached garage at the back along with a concrete pad which leads to a back alley.",
    ...
    3,
    3,
    "126 CITYSCAPE Terrace",
    "NE",
    'mikailmunir01@gmail.com',
    'bamberrealty.c21.ca/',
    'sophia-klassen.c21.ca/',
    "../img/126 CITYSCAPE Terrace.jpeg"
  );
INSERT INTO `nextHome`.`Listings` (
    MLSCode,
    BasementType,
...
VALUES (
    'A1161569',
    'Full, Unfinished',
    'Immaculately kept stunning home with great curb appeal! 
...
family room. The kitchen boasts stainless steel appliances, large centre island, quartz countertops, corner pantry,
 ...
 least is the spacious loft offering an extra space for the whole family. The basement is unfinished with lots of potential.',
    ...
    'cirrealty.ca/',
    'cirrealty.ca/aimee_manser',
    "../img/288 Saddlecrest Way.jpeg"
  );
INSERT INTO `nextHome`.`Review` (
    Email,
    ReviewDescription,
    ReviewDate,
    Flag,
...
Values(
    "mikailmunir01@gmail.com",
    "Don’t let those industrial buildings fool you, you’ll open doors to amazing thrills only found in the North East! Tap into your inner Viking at BATL: Axe Throwing or experience the biggest indoor inflatable park in North America at Big Fun Play Centre with mazes, castles and more for all ages! ",
    'Dec 12, 2021, 1:45PM',
    0,
    "NE",
    "Industrial Park of Unexpected Thrills",
    5
  );
INSERT INTO `nextHome`.`Review` (
    Email,
...
Values(
    "jeffsmith@gmail.com",
    "WinSport & Canada Olympic Park gained global fame during the 1988 Winter Olympics and is now a home-grown icon to visitors and locals alike. This attraction has many summer & winter activities for the whole family to enjoy, and makes a great day out filled with adventure for friends, regardless of the season!
...
Values(
    "mikailmunir01@gmail.com",
    "Extremely convenient area. Everything is close by! Grocery stores, gyms, recreational locations, and even the airport! Everything you could possibly need is no more than a 15-20 minute drive away.",
    'Dec 02, 2021, 3:38PM',
    0,
    "NE",
...
Values(
    "jeffsmith@gmail.com",
    "Southeast Calgary is known for its wide open green spaces, spectacular mountain views and beautiful river valley. It offers a perfect blend of country and city living and features more Calgary lake communities than any other quadrant in the city.",
    'Dec 14, 2021, 6:24PM',
    0,
    "SE",
    "Awesome Place!",
...
Values(
    "aashirbadd@gmail.com",
    "There are so many lively and multicultural comunities in this area. It makes for fun, educational, and fulfilling experiences. NE Calgary is incredibly diverse, welcoming, and offers many opportunites for self developement.",
    'Dec 04, 2021, 6:44PM',
    0,
    "NE",
    "Multiculturalism",
...
Values(
    "jeffsmith@gmail.com",
    "Greenspaces and natural landscapes make up a lot of Calgary (over 8000 hectares) and many of these urban getaways are waiting for you in the South East. Feel connected to nature with a hike, bike or beach day in Fish Creek Provincial Park. Try your hand at fly fishing in the world-renowned Bow River, a fly fisher’s paradise. Out Fly Fishing Outfitters can set you up with equipment or take you out on a guided trip to show you the ropes. Discover a new species and explore the Inglewood Bird Sanctuary, free of charge – just remember to be mindful of the environment when taking in this hidden gem. And the best part? You can use Calgary's seemingly never-ending bike paths to access them all. ",
    'Dec 14, 2021, 6:37PM',
    0,
    "SE",
    "Biking and Birds and Fish? Oh My!",
    4
  );
INSERT INTO `nextHome`.`Review` (
    Email,
...
Values(
    "testuser@nexthome.com",
    "The North East hosts its own share of gorgeous parks and pathways to be explored. Prairie Winds is a massive spot with great hiking trails and grassy two-stepping fields in August during Country Thunder, a Country music weekend held in August. Tom Campbell’s Hill Natural Park has a great off-leash park, interpretive exhibit, splash parks and beautiful lookouts of downtown Calgary that are Instagram worthy. ",
    'Dec 02, 2021, 1:45PM',
    0,
    "NE",
    "Parks and Pathways",
...
Values(
    ...
    0,
    "NW",
    "Lush Parks, Pathways & Greenspaces ",
    4
  );
INSERT INTO `nextHome`.`Review` (
    Email,
...
Values(
    "mikailmunir01@gmail.com",
    "The North West is home to big brand shopping centres and malls for family & friends alike. This fresh approach to shopping can make your shopping trip a full day experience with outlets at CrossIron Mills, big brand stores at CF Market Mall, and family friendly shopping at Northland Village Mall.",
    'Dec 08, 2021, 6:22PM',
    0,
    "NW",
...
When you’re craving something bakeries and ice cream shops can’t offer, treat yourself to some rest, relaxation and Rosso at Distilled Beauty Bar. This all-in-one bar/social house/spa serves tapas, coffee, wine and cocktails and also offers gluten free, vegan and vegetarian options. Come in with some friends for drinks and snacks or make a day of it by indulging in one of the many beauty treatments.",
    ...
    0,
    "SW",
    "Find the Best Sweets & Treats in Marda Loop",
    4
  );
INSERT INTO `nextHome`.`Review` (
    Email,
...
Values(
    "aashirbadd@gmail.com",
    "Locals know that the North West is home to beautiful golf courses in and around the city. This makes for a unique destination for local golf enthusiasts, as many of these courses offer unparalleled mountain & city views, immaculate fairways and bent grass greens which makes the North West home of world-class, yet easy-going mountain golf. Most of these courses are open to the public at very reasonable rates and are open to the people of all ages and skill levels.",
    'Dec 10, 2021, 4:44PM',
    0,
    "NW",
    "City & Mountain View Golf Courses",
    4
  );
INSERT INTO `nextHome`.`Review` (
    Email,
